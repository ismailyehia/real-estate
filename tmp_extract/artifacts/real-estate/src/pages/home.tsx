        ...
        <div className="container mx-auto px-4 z-10 relative mt-16">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-display font-bold text-white leading-tight mb-6">
              Find Your <span className="text-accent italic pr-2">Dream</span> Home.
            </h1>
            ...
            <div className="bg-white p-4 rounded-2xl shadow-2xl max-w-2xl">
              ...
              <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-3">
                ...
                <Button type="submit" size="lg" variant="accent" className="h-14 px-8 text-lg w-full md:w-auto">
                  Search
                </Button>
              </form>
            </div>
